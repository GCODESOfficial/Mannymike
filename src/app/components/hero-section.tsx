...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden md:pt-16 md:px-6 bg-white flex flex-col items-center justify-center text-[#1a1a1a] -mt-14 md:-mt-7">
      {/* Text Content */}
          ...
          <div className="relative w-screen md:h-[20rem] flex md:items-end items-center justify-center">
            ...
            {/* <div className="group absolute md:bottom-10 bottom-2 z-20 flex md:gap-4 gap-2 md:flex-wrap justify-center bg-[#ffffff55] border border-[#C9C9C9] rounded-full p-1 text-xs md:text-base">
              ...
              <a
                ...
                target="_blank"
                className="text-black group-hover:bg-[#C199D7] group-hover:border border-white border md:border-0  md:px-6 py-3 px-3 rounded-full transition duration-300 font-[TTFirsNeueReg] flex items-center  hover:font-bold"
              >
                Let&apos;s Work Together
            ...
            <div className="group absolute md:bottom-10 bottom-2 z-20 flex md:gap-4 gap-2 md:flex-wrap justify-center bg-[#ffffff55] border border-[#C9C9C9] rounded-full p-1 text-xs md:text-base">
              <a
                href="#testimonials"
                className="bg-[#C199D7] flex items-center border border-white text-black font-[TTFirsNeueReg] font-extrabold md:px-6 py-3 px-4 rounded-full transition-all duration-300 ease-in-out hover:bg-transparent hover:border-[#C199D7]"
              >
                View My Work
                <ArrowRight className="text-black -rotate-45 md:ml-2 ml-1 transition-transform duration-300 md:h-8 md:w-8 w-5 h-5 font-[TTFirsNeueReg]" />
              </a>
              <a
                href="https://wa.me/+2348104283896"
                target="_blank"
                className="bg-transparent border border-white text-black font-[TTFirsNeueReg] font-extrabold md:px-6 py-3 px-4 rounded-full transition-all duration-300 ease-in-out hover:bg-[#C199D7] hover:border-[#C199D7] flex items-center"
              >
                Let&apos;s Work Together
                <ArrowRight className="text-black -rotate-45 md:ml-2 ml-1 transition-transform duration-300 md:h-8 md:w-8 w-5 h-5 font-[TTFirsNeueReg]" />
              </a>
